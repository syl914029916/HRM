	...
	<%-- <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><img
				src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;修改部门</td>
			<td width="15" height="32"><img
...
<table width="90%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	<s:form theme="simple" action="/dept/updateDept.action" id="deptForm" method="post">
		  ...
		  <table class="font3t" width="90%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<input class="form" type="text" placeholder="请输入部门名" style="border-radius:5px" name="dept.name"  value="${dept.name}" id="name" size="20"/>
			<br/>
			<br/>
			</td>
