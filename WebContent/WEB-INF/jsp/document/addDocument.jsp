...
.file1{
	...
	<body>
	<div class="usr">
			<font color=#606266 size="5">&nbsp;&nbsp;&nbsp; 添加文档</font>
		  	...
		  	<tr valign="top">
			    <td>
				  <table class="font3t" width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
				  	...
				  	<!-- 表单 -->
				  	<form id="documentForm" name="documentForm" action="${ctx}/document/addDocument.action" method="post" enctype="multipart/form-data">
					    ...
					    <input class="form" type="text" placeholder="请输入公告标题" style="border-radius:5px" name="document.title" size="30" value="" id="title"/>
						...
						<br/>
							<textarea name="document.remark" style="border-radius:5px;border-color: #C0C4CC;border: solid;border-width: 1px;"cols="88" rows="11" id="content"></textarea>
						<br/><br/>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
