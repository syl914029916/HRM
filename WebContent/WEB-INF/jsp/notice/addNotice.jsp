        ...
        <script type="text/javascript" src="${ctx}/js/jquery.form.js"></script>
 		...
 		$(function(){
 			...
 			$("#btn").click(function(){
 	 		 ...
 	 		 $('#picForm').ajaxForm({
                  url:"${ctx}/notice/fileUpload.action",
                  dataType:"json",//服务器返回的数据类型   text    xml
                  success:function(json){
                	  if(json.type=="image"){
                    	  tinyMCE.execCommand('mceInsertContent',false,"<img src='${ctx}/"+json.path+"' width='200px' height='200px'/>");

                	  }else{
                		  alert(json.name);
                		  //用户上传的为txt、doc之类的办公文档
                		  alert("用户上传的不是图片");
                		  $("#attachment").html("<a href='${ctx}/notice/downFile.action?filePath="+json.path+"'>"+json.name+"</a>");
                	  }
                  },error:function(){
                	  alert("文件上传失败！");
                  }
...
.button2
	...
	<div class="usr">
			<font color=#606266 size="5">&nbsp;&nbsp;&nbsp;添加公告</font>
		  	...
		  	<tr valign="top">
			    <td>
				  <table class="font3t" width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
				  	...
				  	<!-- 表单 -->
				  	<form id="noticeForm" name="noticeForm" action="${ctx}/notice/addNotice.action" method="post">
					    ...
					    <input class="form" type="text" placeholder="请输入公告标题" style="border-radius:5px" name="notice.title" size="30" value="" id="title"/>
						...
						<tr><td class="font3 fftd">公告内容<br/><br/>
							<textarea name="notice.content" cols="88" rows="11" id="content"></textarea>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
